...
function GenerarMeme() {
  textArriba = document.getElementById("textoArriba").value;
  textAbajo = document.getElementById("textoAbajo").value;
  ...
  ObjetoImagen.onload = function () {
    ...
    ctx.strokeText(textArriba, x, 50);
    ctx.fillText(textArriba, x, 50);
  };
